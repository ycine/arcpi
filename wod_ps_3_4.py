...
it = arcpy.env.workspace = r"Database Connections\s4.asc-polska.pl.wod_ps_v_3_4_o.WOD_PS_V_3_4_O_OWNER.sde\wod_ps_v_3_4_o.WOD_PS_V_3_4_O_OWNER.WAT"
...
e = "Database Connections\s4.asc-polska.pl.wod_ps_v_3_4_o.WOD_PS_V_3_4_O_OWNER.sde"
...
set = []
with arcpy.da.SearchCursor("wod_ps_v_3_4_o.WOD_PS_V_3_4_O_OWNER.Obreby_Swiecie35",'jpt_nazwa_') as se:
    for i in se:
        set.append(i)

for dx in set:
    lupa = "\"jpt_nazwa_\" = '%s'" %(dx)
    ui = arcpy.SelectLayerByAttribute_management("wod_ps_v_3_4_o.WOD_PS_V_3_4_O_OWNER.Obreby_Swiecie35","NEW_SELECTION", lupa)
    #DO TEGO MOMENTU JEST OK

    for i in feczu_list:
        selectl = arcpy.SelectLayerByLocation_management(i, "WITHIN", "wod_ps_v_3_4_o.WOD_PS_V_3_4_O_OWNER.Obreby_Swiecie35")
    for i in feczu_list:
